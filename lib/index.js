...
module.exports = AjvMoment;

/**
 * Plugin constructor
 * @param {Object} [options]
 */
function AjvMoment(options) {
    // for future proofing this plugin, we use a constructor that can accept
    // options for use in customizing plugin functionality
    this.options = options;
}


/**
 * Retreive the plugin object for ajv's #addKeyword method
 * @param {Object} ajv - optional ajv instance to add keyword on
 * @return {Object}
 */
AjvMoment.prototype.plugin = function(ajv) {
    this.isntance = ajv;
